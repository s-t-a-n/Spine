...
void ut_unit_composite_addition() {
    using namespace spnu;
    using mls = CompositeUnit<litre_ml, time_s>;
    using lpm = CompositeUnit<litre, time_m>;
...
void ut_unit_composite_multiplication() {
    using namespace spn::structure::units;
    using mls = CompositeUnit<litre_ml, time_s>;
...
void ut_unit_composite_division() {
    using namespace spn::structure::units;
    using mls = CompositeUnit<litre_ml, time_s>;
...
void ut_unit_composite_subtraction_assignment() {
    using namespace spn::structure::units;
    using mls = CompositeUnit<litre_ml, time_s>;
...
void ut_unit_composite_addition_assignment() {
    using namespace spn::structure::units;
    using mls = CompositeUnit<litre_ml, time_s>;
...
void ut_unit_composite_comparisons() {
    using namespace spn::structure::units;
    using mls = CompositeUnit<litre_ml, time_s>;
...
void ut_unit_composite_simplification() {
    using namespace spn::structure::units;
    using mls = CompositeUnit<litre_ml, time_s>;
...
void ut_unit_composite_unary_minus() {
    using namespace spn::structure::units;
    using mls = CompositeUnit<litre_ml, time_s>;
...
void ut_unit_composite_scalar_operations() {
    using namespace spn::structure::units;
    using mls = CompositeUnit<litre_ml, time_s>;
...
void ut_unit_composite_edge_cases() {
    using namespace spn::structure::units;
    using mls = CompositeUnit<litre_ml, time_s>;
...
void ut_unit_composite_conversions() {
    using namespace spn::structure::units;
    using mls = CompositeUnit<litre_ml, time_s>;
    using lps = CompositeUnit<litre, time_s>;
...
void ut_unit_composite_exception_handling() {
    using namespace spn::structure::units;
    using namespace spn::core;
...
int run_all_tests() {
    ...
    RUN_TEST(ut_unit_composite);
    RUN_TEST(ut_unit_composite_addition);
    RUN_TEST(ut_unit_composite_multiplication);
    RUN_TEST(ut_unit_composite_division);
    RUN_TEST(ut_unit_composite_subtraction_assignment);
    RUN_TEST(ut_unit_composite_addition_assignment);
    RUN_TEST(ut_unit_composite_comparisons);
    RUN_TEST(ut_unit_composite_simplification);
    RUN_TEST(ut_unit_composite_unary_minus);
    RUN_TEST(ut_unit_composite_scalar_operations);
    RUN_TEST(ut_unit_composite_edge_cases);
    RUN_TEST(ut_unit_composite_conversions);
    RUN_TEST(ut_unit_composite_exception_handling);
    return UNITY_END();
}
